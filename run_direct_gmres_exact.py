...
#         OptDB.setValue('pc_hypre_type',   'pilut')
#         OptDB.setValue('pc_hypre_type',   'euclid')
#         OptDB.setValue('pc_hypre_euclid_levels', 3)
        
        OptDB.setValue('ksp_atol',   1E-8)
        ...
        self.snes_linear.getKSP().setType('lgmres')
#         self.snes_linear.getKSP().setType('preonly')
#         self.snes_linear.getKSP().getPC().setType('none')
        self.snes_linear.getKSP().getPC().setType('bjacobi')
#         self.snes_linear.getKSP().getPC().setType('hypre')
...
#         self.snes_linear.getKSP().getPC().setFactorSolverPackage('mumps')
        ...
        self.snes.getKSP().setType('lgmres')
