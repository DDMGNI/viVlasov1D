...
#
#$ -o /ptmp1/mkraus/petscVlasovPoisson1D/jeans_strong_201x401_dt1E-1_nu2E-3.out
#$ -e /ptmp1/mkraus/petscVlasovPoisson1D/jeans_strong_201x401_dt1E-1_nu2E-3.err
#
#$ -m e
...
mpiexec -n 8 python3.2 run_direct_nonlinear_exact_corr.py runs/$RUNID.cfg
