...
cdef class PETScFunction(object):
    ...
    def snes_mult_all(self, SNES snes, Vec X, Vec Y):
        self.mult_all(X, Y)
    ...
    def mult_all(self, Vec X, Vec Y):
        self.update_moments(X)
        self.mult(X, Y, moments=True)
    
    
    @cython.boundscheck(False)
    def mult(self, Vec X, Vec Y, moments=False):
        ...
        self.matrix_mult(Y, moments=moments)
        
    
    @cython.boundscheck(False)
    def matrix_mult(self, Vec Y, moments=True):
