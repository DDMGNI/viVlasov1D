...
ext_modules = [
        ...
        Extension("PETScSimpleNLMFJacobian",
                  sources=["PETScSimpleNLMFJacobian.pyx"],
                  include_dirs=INCLUDE_DIRS + [os.curdir],
                  libraries=LIBRARIES,
                  library_dirs=LIBRARY_DIRS,
                  runtime_library_dirs=LIBRARY_DIRS
        ...
        Extension("PETScSimpleMatrixCollN1",
                  sources=["PETScSimpleMatrixCollN1.pyx"],
                  include_dirs=INCLUDE_DIRS + [os.curdir],
                  libraries=LIBRARIES,
                  library_dirs=LIBRARY_DIRS,
                  runtime_library_dirs=LIBRARY_DIRS
                 ),
        Extension("PETScSimpleNLFunctionCollN1",
                  sources=["PETScSimpleNLFunctionCollN1.pyx"],
                  include_dirs=INCLUDE_DIRS + [os.curdir],
                  libraries=LIBRARIES,
                  library_dirs=LIBRARY_DIRS,
                  runtime_library_dirs=LIBRARY_DIRS
                 ),
        Extension("PETScSimpleNLJacobianCollN1",
                  sources=["PETScSimpleNLJacobianCollN1.pyx"],
                  include_dirs=INCLUDE_DIRS + [os.curdir],
                  libraries=LIBRARIES,
                  library_dirs=LIBRARY_DIRS,
                  runtime_library_dirs=LIBRARY_DIRS
                 ),
        Extension("PETScSimpleNLMFJacobianCollN1",
                  sources=["PETScSimpleNLMFJacobianCollN1.pyx"],
                  include_dirs=INCLUDE_DIRS + [os.curdir],
                  libraries=LIBRARIES,
                  library_dirs=LIBRARY_DIRS,
                  runtime_library_dirs=LIBRARY_DIRS
