...
#        cdef np.float64_t coll2_fac = 0.
        ...
        cdef np.float64_t coll1_fac = - 0.5 * self.nu * 0.25 * 0.5 / self.hv**3
        cdef np.float64_t coll2_fac = - 0.5 * self.nu * 0.25       / self.hv**4
