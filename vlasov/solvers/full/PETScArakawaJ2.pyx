            ...
            for j in range(0, self.nv):
                ...
                if j <= 1 or j >= self.nv-2:
                    ...
                    for index, field, value in [
                            ...
                            ((i-1,), j-1, - (hh[ix-2, j  ] - hh[ix,   j-2]) * arak_fac_J2 \
                                          - (hh[ix-1, j+1] - hh[ix+1, j-1]) * arak_fac_J2),
                            ((i-1,), j+1, - (hh[ix,   j+2] - hh[ix-2, j  ]) * arak_fac_J2 \
                                          - (hh[ix+1, j+1] - hh[ix-1, j-1]) * arak_fac_J2),
                            ...
                            ((i-2,), self.nv, + (fh[ix-1, j+1] - fh[ix-1, j-1]) * arak_fac_J2),
                            ((i-1,), self.nv, + (fh[ix-1, j+1] - fh[ix+1, j-1]) * arak_fac_J2 \
                                              + (fh[ix+1, j+1] - fh[ix-1, j-1]) * arak_fac_J2 \
                                              + (fh[ix-2, j  ] - fh[ix,   j-2]) * arak_fac_J2 \
                                              + (fh[ix,   j+2] - fh[ix-2, j  ]) * arak_fac_J2),
                            ((i,  ), self.nv, + (fh[ix+1, j+1] - fh[ix-1, j+1]) * arak_fac_J2 \
                                              - (fh[ix+1, j-1] - fh[ix-1, j-1]) * arak_fac_J2),
                            ((i+1,), self.nv, - (fh[ix-1, j+1] - fh[ix+1, j-1]) * arak_fac_J2 \
                                              - (fh[ix+1, j+1] - fh[ix-1, j-1]) * arak_fac_J2 \
                                              - (fh[ix,   j+2] - fh[ix+2, j  ]) * arak_fac_J2 \
