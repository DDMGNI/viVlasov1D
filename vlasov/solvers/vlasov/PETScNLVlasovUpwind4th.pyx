...
#         cdef npy.float64_t arak_fac = 0.5 / (3. * self.hx * self.hv)
#         
...
#                             ((i-1,), j-1, - h_ave[ix-1, j  ] * arak_fac),
#                             ((i-1,), j  , + h_ave[ix-1, j-1] * arak_fac),
#                             
#                             ((i,  ), j-1, + h_ave[ix+1, j  ] * arak_fac \
#                                           - coll_drag_fac * ( self.np[ix  ] * self.v[j-1] - self.up[ix  ] ) * self.ap[ix  ] \
#                                           + coll_diff_fac),
#                             ((i,  ), j  , + time_fac
#                                           - 2. * coll_diff_fac),
#                             ((i,  ), j+1, - h_ave[ix+1, j+1] * arak_fac \
#                                           + coll_drag_fac * ( self.np[ix  ] * self.v[j+1] - self.up[ix  ] ) * self.ap[ix  ] \
#                                           + coll_diff_fac),
#                             
#                             ((i+1,), j  , - h_ave[ix,   j-1] * arak_fac),
#                             ((i+1,), j+1, + h_ave[ix,   j+1] * arak_fac),
#                         ]:
# 
#                         col.index = index
#                         col.field = field
...
#         A.assemble()
    ...
    def jacobian(self, Vec Y):
        ...
        cdef npy.float64_t result, coll_drag, coll_diff
        ...
        for i in range(xs, xe):
            ...
            for j in range(0, self.nv):
                if j < self.da1.getStencilWidth() or j >= self.nv-self.da1.getStencilWidth():
                    ...
                    result += ( \
                             + fd[ix+2, j+1] * h_ave[ix+2, j+2] \
                             - fd[ix+1, j+2] * h_ave[ix+2, j+2] \
                             - fd[ix+1, j  ] * h_ave[ix+2, j+2] \
                             + fd[ix,   j+1] * h_ave[ix+2, j+2] \
                             - fd[ix+2, j+2] * h_ave[ix+2, j+1] \
                             - fd[ix+2, j  ] * h_ave[ix+2, j+1] \
                             - fd[ix,   j+1] * h_ave[ix+2, j+1] \
                             - fd[ix,   j-1] * h_ave[ix+2, j+1] \
                             - fd[ix+2, j-2] * h_ave[ix+2, j-1] \
                             - fd[ix+2, j  ] * h_ave[ix+2, j-1] \
                             - fd[ix,   j+1] * h_ave[ix+2, j-1] \
                             ...
                             + fd[ix+1, j  ] * h_ave[ix+2, j-2] \
                             + fd[ix,   j-1] * h_ave[ix+2, j-2] \
                             + fd[ix+2, j+1] * h_ave[ix+2, j  ] \
                             + fd[ix+2, j-1] * h_ave[ix+2, j  ] \
                             + fd[ix,   j+1] * h_ave[ix+2, j  ] \
                             + fd[ix,   j-1] * h_ave[ix+2, j  ] \
                             + fd[ix+2, j+2] * h_ave[ix+1, j+2] \
                             + fd[ix+1, j  ] * h_ave[ix+1, j+2] \
                             + fd[ix-1, j  ] * h_ave[ix+1, j+2] \
                             + fd[ix,   j+2] * h_ave[ix+1, j+2] \
                             - fd[ix+2, j-2] * h_ave[ix+1, j-2] \
                             - fd[ix+1, j  ] * h_ave[ix+1, j-2] \
                             - fd[ix-1, j  ] * h_ave[ix+1, j-2] \
                             - fd[ix,   j-2] * h_ave[ix+1, j-2] \
                             + fd[ix+2, j+2] * h_ave[ix+1, j  ] \
                             - fd[ix+2, j-2] * h_ave[ix+1, j  ] \
                             - fd[ix+1, j+2] * h_ave[ix+1, j  ] \
                             + fd[ix+1, j-2] * h_ave[ix+1, j  ] \
                             - fd[ix-1, j+2] * h_ave[ix+1, j  ] \
                             + fd[ix-1, j-2] * h_ave[ix+1, j  ] \
                             + fd[ix,   j+2] * h_ave[ix+1, j  ] \
                             - fd[ix,   j-2] * h_ave[ix+1, j  ] \
                             + fd[ix+1, j  ] * h_ave[ix-1, j+2] \
                             + fd[ix-1, j  ] * h_ave[ix-1, j+2] \
                             + fd[ix-2, j+2] * h_ave[ix-1, j+2] \
                             ...
                             - fd[ix,   j+1] * h_ave[ix-2, j  ] \
                             - fd[ix,   j-1] * h_ave[ix-2, j  ] \
                             - fd[ix+1, j+2] * h_ave[ix,   j+2] \
                             - fd[ix+1, j  ] * h_ave[ix,   j+2] \
                             - fd[ix-1, j+2] * h_ave[ix,   j+2] \
                             - fd[ix-1, j  ] * h_ave[ix,   j+2] \
                             - fd[ix+2, j+2] * h_ave[ix,   j+1] \
                             + fd[ix+2, j+1] * h_ave[ix,   j+1] \
                             + fd[ix+2, j-1] * h_ave[ix,   j+1] \
                             - fd[ix+2, j  ] * h_ave[ix,   j+1] \
                             + fd[ix-2, j+2] * h_ave[ix,   j+1] \
                             - fd[ix-2, j+1] * h_ave[ix,   j+1] \
                             - fd[ix-2, j-1] * h_ave[ix,   j+1] \
                             + fd[ix-2, j  ] * h_ave[ix,   j+1] \
                    ...
                    result += ( \
                             - fd[ix+2, j  ] * h_ave[ix+2, j+2] \
                             + fd[ix,   j+2] * h_ave[ix+2, j+2] \
                             + fd[ix+2, j  ] * h_ave[ix+2, j-2] \
                             - fd[ix,   j-2] * h_ave[ix+2, j-2] \
                             + fd[ix+2, j+2] * h_ave[ix+2, j  ] \
                             - fd[ix+2, j-2] * h_ave[ix+2, j  ] \
                             + fd[ix,   j+2] * h_ave[ix+2, j  ] \
                             - fd[ix,   j-2] * h_ave[ix+2, j  ] \
                             + fd[ix-2, j  ] * h_ave[ix-2, j+2] \
                             - fd[ix,   j+2] * h_ave[ix-2, j+2] \
                             - fd[ix-2, j  ] * h_ave[ix-2, j-2] \
                             ...
                             - fd[ix,   j+2] * h_ave[ix-2, j  ] \
                             + fd[ix,   j-2] * h_ave[ix-2, j  ] \
                             - fd[ix+2, j+2] * h_ave[ix,   j+2] \
                             - fd[ix+2, j  ] * h_ave[ix,   j+2] \
                             + fd[ix-2, j+2] * h_ave[ix,   j+2] \
                             + fd[ix-2, j  ] * h_ave[ix,   j+2] \
                             + fd[ix+2, j-2] * h_ave[ix,   j-2] \
                             + fd[ix+2, j  ] * h_ave[ix,   j-2] \
                    ...
                    y[iy, j] = fd[ix, j] * self.ht_inv \
                             + 0.5 * result  * self.hx_inv * self.hv_inv \
        ...
        for i in range(xs, xe):
            ...
            for j in range(0, self.nv):
                if j < self.da1.getStencilWidth() or j >= self.nv-self.da1.getStencilWidth():
                    ...
                    result += ( \
                             + f_ave[ix+2, j+1] * h_ave[ix+2, j+2] \
                             - f_ave[ix+1, j+2] * h_ave[ix+2, j+2] \
                             - f_ave[ix+1, j  ] * h_ave[ix+2, j+2] \
                             + f_ave[ix,   j+1] * h_ave[ix+2, j+2] \
                             - f_ave[ix+2, j+2] * h_ave[ix+2, j+1] \
                             - f_ave[ix+2, j  ] * h_ave[ix+2, j+1] \
                             - f_ave[ix,   j+1] * h_ave[ix+2, j+1] \
                             - f_ave[ix,   j-1] * h_ave[ix+2, j+1] \
                             - f_ave[ix+2, j-2] * h_ave[ix+2, j-1] \
                             - f_ave[ix+2, j  ] * h_ave[ix+2, j-1] \
                             - f_ave[ix,   j+1] * h_ave[ix+2, j-1] \
                             ...
                             + f_ave[ix+1, j  ] * h_ave[ix+2, j-2] \
                             + f_ave[ix,   j-1] * h_ave[ix+2, j-2] \
                             + f_ave[ix+2, j+1] * h_ave[ix+2, j  ] \
                             + f_ave[ix+2, j-1] * h_ave[ix+2, j  ] \
                             + f_ave[ix,   j+1] * h_ave[ix+2, j  ] \
                             + f_ave[ix,   j-1] * h_ave[ix+2, j  ] \
                             + f_ave[ix+2, j+2] * h_ave[ix+1, j+2] \
                             + f_ave[ix+1, j  ] * h_ave[ix+1, j+2] \
                             + f_ave[ix-1, j  ] * h_ave[ix+1, j+2] \
                             + f_ave[ix,   j+2] * h_ave[ix+1, j+2] \
                             - f_ave[ix+2, j-2] * h_ave[ix+1, j-2] \
                             - f_ave[ix+1, j  ] * h_ave[ix+1, j-2] \
                             - f_ave[ix-1, j  ] * h_ave[ix+1, j-2] \
                             - f_ave[ix,   j-2] * h_ave[ix+1, j-2] \
                             + f_ave[ix+2, j+2] * h_ave[ix+1, j  ] \
                             - f_ave[ix+2, j-2] * h_ave[ix+1, j  ] \
                             - f_ave[ix+1, j+2] * h_ave[ix+1, j  ] \
                             + f_ave[ix+1, j-2] * h_ave[ix+1, j  ] \
                             - f_ave[ix-1, j+2] * h_ave[ix+1, j  ] \
                             + f_ave[ix-1, j-2] * h_ave[ix+1, j  ] \
                             + f_ave[ix,   j+2] * h_ave[ix+1, j  ] \
                             - f_ave[ix,   j-2] * h_ave[ix+1, j  ] \
                             + f_ave[ix+1, j  ] * h_ave[ix-1, j+2] \
                             + f_ave[ix-1, j  ] * h_ave[ix-1, j+2] \
                             + f_ave[ix-2, j+2] * h_ave[ix-1, j+2] \
                             ...
                             - f_ave[ix,   j+1] * h_ave[ix-2, j  ] \
                             - f_ave[ix,   j-1] * h_ave[ix-2, j  ] \
                             - f_ave[ix+1, j+2] * h_ave[ix,   j+2] \
                             - f_ave[ix+1, j  ] * h_ave[ix,   j+2] \
                             - f_ave[ix-1, j+2] * h_ave[ix,   j+2] \
                             - f_ave[ix-1, j  ] * h_ave[ix,   j+2] \
                             - f_ave[ix+2, j+2] * h_ave[ix,   j+1] \
                             + f_ave[ix+2, j+1] * h_ave[ix,   j+1] \
                             + f_ave[ix+2, j-1] * h_ave[ix,   j+1] \
                             - f_ave[ix+2, j  ] * h_ave[ix,   j+1] \
                             + f_ave[ix-2, j+2] * h_ave[ix,   j+1] \
                             - f_ave[ix-2, j+1] * h_ave[ix,   j+1] \
                             - f_ave[ix-2, j-1] * h_ave[ix,   j+1] \
                             + f_ave[ix-2, j  ] * h_ave[ix,   j+1] \
                    ...
                    result += ( \
                             - f_ave[ix+2, j  ] * h_ave[ix+2, j+2] \
                             + f_ave[ix,   j+2] * h_ave[ix+2, j+2] \
                             + f_ave[ix+2, j  ] * h_ave[ix+2, j-2] \
                             - f_ave[ix,   j-2] * h_ave[ix+2, j-2] \
                             + f_ave[ix+2, j+2] * h_ave[ix+2, j  ] \
                             - f_ave[ix+2, j-2] * h_ave[ix+2, j  ] \
                             + f_ave[ix,   j+2] * h_ave[ix+2, j  ] \
                             - f_ave[ix,   j-2] * h_ave[ix+2, j  ] \
                             + f_ave[ix-2, j  ] * h_ave[ix-2, j+2] \
                             - f_ave[ix,   j+2] * h_ave[ix-2, j+2] \
                             - f_ave[ix-2, j  ] * h_ave[ix-2, j-2] \
                             ...
                             - f_ave[ix,   j+2] * h_ave[ix-2, j  ] \
                             + f_ave[ix,   j-2] * h_ave[ix-2, j  ] \
                             - f_ave[ix+2, j+2] * h_ave[ix,   j+2] \
                             - f_ave[ix+2, j  ] * h_ave[ix,   j+2] \
                             + f_ave[ix-2, j+2] * h_ave[ix,   j+2] \
                             + f_ave[ix-2, j  ] * h_ave[ix,   j+2] \
                             + f_ave[ix+2, j-2] * h_ave[ix,   j-2] \
                             + f_ave[ix+2, j  ] * h_ave[ix,   j-2] \
                    ...
                    y[iy, j] = (fp[ix, j] - fh[ix, j]) * self.ht_inv \
                             + 1.0 * result * self.hx_inv * self.hv_inv \
                             - 0.5 * self.nu * self.coll_drag * coll_drag * self.hv_inv * 0.5 \
                             - 0.5 * self.nu * self.coll_diff * coll_diff * self.hv2_inv
