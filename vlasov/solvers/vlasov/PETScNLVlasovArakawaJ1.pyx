...
#         cdef np.float64_t coll_diff_fac = 0.
        ...
        cdef np.float64_t coll_drag_fac = - 0.5 * self.coll_drag * self.nu * self.grid.hv_inv * 0.5
        cdef np.float64_t coll_diff_fac = - 0.5 * self.coll_diff * self.nu * self.grid.hv2_inv
