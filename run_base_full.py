...
#         self.x_nvec.normalize()
    ...
    def copy_x_to_f(self):
        ...
        f_arr = getGlobalArray(self.da1, self.f)
    ...
    def copy_x_to_p(self):
        x_arr = self.da2.getGlobalArray(self.x)
        p_arr = getGlobalArray(self.dax, self.p)
    ...
    def copy_x_to_n(self):
        x_arr = self.da2.getGlobalArray(self.x)
        n_arr = getGlobalArray(self.dax, self.n)
    ...
    def copy_x_to_u(self):
        x_arr = self.da2.getGlobalArray(self.x)
        u_arr = getGlobalArray(self.dax, self.u)
    ...
    def copy_x_to_e(self):
        x_arr = self.da2.getGlobalArray(self.x)
        e_arr = getGlobalArray(self.dax, self.e)
