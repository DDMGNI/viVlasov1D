...
#$ -pe impi_hydra 16
#
#$ -o /ptmp1/mkraus/petscVlasovPoisson1D/landau02_201x401_dt1E-3_nu0_linear.out
#$ -e /ptmp1/mkraus/petscVlasovPoisson1D/landau02_201x401_dt1E-3_nu0_linear.err
#
#$ -m e
...
RUNID=landau02_201x401_dt1E-3_nu0_linear
...
mpiexec -n 8 python3.2 run_direct_linear.py -c runs_itm/$RUNID.cfg
