...
#$ -pe impi_hydra 16
#
#$ -o /pfs/scratch/mkraus/petscVlasovPoisson1D/jeans_strong_201x401_dt1E-1_nu4E-3.out
#$ -e /pfs/scratch/mkraus/petscVlasovPoisson1D/jeans_strong_201x401_dt1E-1_nu4E-3.err
#
#$ -m e
...
RUNID=jeans_strong_201x401_dt1E-1_nu4E-3
...
#mpiexec -perhost 16 -l -n 16 python3.2 run_direct_nonlinear_exact_pred.py runs/$RUNID.cfg
