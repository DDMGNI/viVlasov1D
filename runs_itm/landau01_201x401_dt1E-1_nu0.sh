...
#$ -pe impi_hydra 16
#
#$ -o /pfs/scratch/mkraus/petscVlasovPoisson1D/landau01_201x401_dt1E-1_nu0.out
#$ -e /pfs/scratch/mkraus/petscVlasovPoisson1D/landau01_201x401_dt1E-1_nu0.err
#
#$ -m e
...
RUNID=landau01_201x401_dt1E-1_nu0
