...
#$ -pe impi_hydra 16
#
#$ -o /pfs/scratch/mkraus/petscVlasovPoisson1D/jeans_strong_201x401_dt1E-1_nu1E-3_nested.out
#$ -e /pfs/scratch/mkraus/petscVlasovPoisson1D/jeans_strong_201x401_dt1E-1_nu1E-3_nested.err
#
#$ -m e
...
RUNID=jeans_strong_201x401_dt1E-1_nu1E-3_nested
