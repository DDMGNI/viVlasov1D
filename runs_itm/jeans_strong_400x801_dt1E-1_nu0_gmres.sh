...
#$ -pe impi_hydra 16
#
#$ -o /pfs/scratch/mkraus/petscVlasovPoisson1D/jeans_strong_400x801_dt1E-1_nu0_gmres.out
#$ -e /pfs/scratch/mkraus/petscVlasovPoisson1D/jeans_strong_400x801_dt1E-1_nu0_gmres.err
#
#$ -m e
...
RUNID=jeans_strong_400x801_dt1E-1_nu0_gmres
...
mpiexec -perhost 16 -l -n 16 python3.3 run_nonlinear_matrixfree_split_pc_exp.py -c runs_itm/$RUNID.cfg
