...
#$ -pe impi_hydra 16
#
#$ -o /pfs/scratch/mkraus/petscVlasovPoisson1D/landau01_200x401_dt1E-1_nu4E-5.out
#$ -e /pfs/scratch/mkraus/petscVlasovPoisson1D/landau01_200x401_dt1E-1_nu4E-5.err
#
#$ -m e
