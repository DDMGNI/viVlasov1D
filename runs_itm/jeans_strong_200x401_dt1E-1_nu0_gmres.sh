...
#$ -pe impi_hydra 16
#
#$ -o /pfs/scratch/mkraus/petscVlasovPoisson1D/jeans_strong_200x401_dt1E-1_nu0_gmres.out
#$ -e /pfs/scratch/mkraus/petscVlasovPoisson1D/jeans_strong_200x401_dt1E-1_nu0_gmres.err
#
#$ -m e
...
RUNID=jeans_strong_200x401_dt1E-1_nu0_gmres
