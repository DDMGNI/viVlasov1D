...
#$ -pe impi_hydra 16
#
#$ -o /pfs/scratch/mkraus/petscVlasovPoisson1D/jeans_strong_201x401_dt1E-3_nu1E-3_gmres.out
#$ -e /pfs/scratch/mkraus/petscVlasovPoisson1D/jeans_strong_201x401_dt1E-3_nu1E-3_gmres.err
#
#$ -m e
...
RUNID=jeans_strong_201x401_dt1E-3_nu1E-3_gmres
...
mpiexec -perhost 16 -l -n 16 python3.2 run_direct_gmres.py -c runs_itm/$RUNID.cfg
