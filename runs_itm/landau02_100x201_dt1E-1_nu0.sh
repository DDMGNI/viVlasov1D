...
#$ -pe impi_hydra 16
#
#$ -o /pfs/scratch/mkraus/petscVlasovPoisson1D/landau02_100x201_dt1E-1_nu0.out
#$ -e /pfs/scratch/mkraus/petscVlasovPoisson1D/landau02_100x201_dt1E-1_nu0.err
#
#$ -m e
...
RUNID=landau02_100x201_dt1E-1_nu0
