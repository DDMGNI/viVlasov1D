...
#$ -pe impi_hydra 16
#
#$ -o /pfs/scratch/mkraus/petscVlasovPoisson1D/jeans_strong_100x201_dt1E-1_nu0.out
#$ -e /pfs/scratch/mkraus/petscVlasovPoisson1D/jeans_strong_100x201_dt1E-1_nu0.err
#
#$ -m e
...
RUNID=jeans_strong_100x201_dt1E-1_nu0
...
#mpiexec -perhost 16 -l -n 16 python3.2 run_direct_nested.py -c runs_itm/$RUNID.cfg
...
#mpiexec -perhost 16 -l -n 16 python3.2 run_direct_nonlinear_ksp.py -c runs_itm/$RUNID.cfg
#mpiexec -perhost 16 -l -n 16 python3.2 run_direct_nonlinear_pred.py -c runs_itm/$RUNID.cfg
mpiexec -perhost 16 -l -n 16 python3.2 run_direct_nonlinear_gmres2.py -c runs_itm/$RUNID.cfg
