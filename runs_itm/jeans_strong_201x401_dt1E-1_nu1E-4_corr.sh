...
#$ -pe impi_hydra 16
#
#$ -o /pfs/scratch/mkraus/petscVlasovPoisson1D/jeans_strong_201x401_dt1E-1_nu1E-4_corr.out
#$ -e /pfs/scratch/mkraus/petscVlasovPoisson1D/jeans_strong_201x401_dt1E-1_nu1E-4_corr.err
#
#$ -m e
...
RUNID=jeans_strong_201x401_dt1E-1_nu1E-4_corr
...
mpiexec -perhost 16 -l -n 16 python3.2 run_direct_gmres_corr.py -c runs_itm/$RUNID.cfg
