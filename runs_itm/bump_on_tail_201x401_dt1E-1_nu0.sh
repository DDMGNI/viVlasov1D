...
#$ -pe impi_hydra 16
#
#$ -o /ptmp1/mkraus/petscVlasovPoisson1D/bump_on_tail_201x401_dt1E-1_nu0.out
#$ -e /ptmp1/mkraus/petscVlasovPoisson1D/bump_on_tail_201x401_dt1E-1_nu0.err
#
#$ -m e
...
RUNID=bump_on_tail_201x401_dt1E-1_nu0
