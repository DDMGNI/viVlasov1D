...
#$ -pe impi_hydra 16
#
#$ -o /ptmp1/mkraus/petscVlasovPoisson1D/landau02_alpha0_dt1e-2_linear.out
#$ -e /ptmp1/mkraus/petscVlasovPoisson1D/landau02_alpha0_dt1e-2_linear.err
#
#$ -m e
...
RUNID=landau02_201x401_dt1E-2_nu0_linear
