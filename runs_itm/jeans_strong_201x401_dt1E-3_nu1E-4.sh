...
#$ -pe impi_hydra 16
#
#$ -o /pfs/scratch/mkraus/petscVlasovPoisson1D/jeans_strong_201x401_dt1E-3_nu1E-4.out
#$ -e /pfs/scratch/mkraus/petscVlasovPoisson1D/jeans_strong_201x401_dt1E-3_nu1E-4.err
#
#$ -m e
...
RUNID=jeans_strong_201x401_dt1E-3_nu1E-4
