...
#        OptDB.setValue('log_summary', '')
        ...
        OptDB.setValue('snes_atol',   self.cfg['solver']['petsc_snes_atol'] * 1E-1)
        OptDB.setValue('ksp_atol',    self.cfg['solver']['petsc_ksp_atol']  * 1E-1)
        OptDB.setValue('ksp_rtol',    self.cfg['solver']['petsc_ksp_rtol']  * 1E-2)
