...
#$ -pe impi_hydra 16
#
#$ -o /tokp/scratch/mkraus/viVlasov1D/twostream_128x256_Arakawa2_Poisson4.$JOB_ID.out
#$ -e /tokp/scratch/mkraus/viVlasov1D/twostream_128x256_Arakawa2_Poisson4.$JOB_ID.err
#
#$ -m e
