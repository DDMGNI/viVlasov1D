...
#$ -pe impi_hydra 16
#
#$ -o /tokp/scratch/mkraus/petscVlasovPoisson1D/twostream_200x401_dt1E-1_nu0_rk2.out
#$ -e /tokp/scratch/mkraus/petscVlasovPoisson1D/twostream_200x401_dt1E-1_nu0_rk2.err
#
#$ -m e
...
RUNID=twostream_201x400_dt1E-1_nu0_rk2
...
mpiexec -perhost 16 -l -n 16 python3.3 run_nonlinear_matrixfree_split_rk2.py -c runs_itm/$RUNID.cfg
