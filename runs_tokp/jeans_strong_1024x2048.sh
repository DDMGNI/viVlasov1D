...
#$ -pe impi_hydra 16 
#
#$ -o /tokp/scratch/mkraus/petscVlasovPoisson1D/jeans_strong_1024x2048.$JOB_ID.out
#$ -e /tokp/scratch/mkraus/petscVlasovPoisson1D/jeans_strong_1024x2048.$JOB_ID.err
#
#$ -m e
