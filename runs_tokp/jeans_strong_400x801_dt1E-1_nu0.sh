...
#$ -pe impi_hydra 16
#
#$ -o /tokp/scratch/mkraus/petscVlasovPoisson1D/jeans_strong_400x801_dt1E-1_nu0.out
#$ -e /tokp/scratch/mkraus/petscVlasovPoisson1D/jeans_strong_400x801_dt1E-1_nu0.err
#
#$ -m e
...
RUNID=jeans_strong_400x801_dt1E-1_nu0
