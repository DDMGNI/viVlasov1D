...
#$ -pe impi_hydra 16
#
#$ -o /tokp/scratch/mkraus/viVlasov1D/landau_linear_256x512_nu8E-4.out
#$ -e /tokp/scratch/mkraus/viVlasov1D/landau_linear_256x512_nu8E-4.err
#
#$ -m e
...
RUNID=landau_linear_256x512_nu8E-4_db
