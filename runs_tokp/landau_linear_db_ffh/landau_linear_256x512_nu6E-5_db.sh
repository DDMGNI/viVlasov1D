...
#$ -pe impi_hydra 16
#
#$ -o /tokp/scratch/mkraus/viVlasov1D/landau_linear_256x512_nu6E-5.out
#$ -e /tokp/scratch/mkraus/viVlasov1D/landau_linear_256x512_nu6E-5.err
#
#$ -m e
...
RUNID=landau_linear_256x512_nu6E-5_db
...
mpiexec -perhost 16 -l -n 16 python3.3 run.py -c runs_tokp/landau_linear_db_ffh/$RUNID.cfg -i $JOB_ID
