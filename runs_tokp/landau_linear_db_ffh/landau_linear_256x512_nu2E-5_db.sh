...
#$ -pe impi_hydra 16
#
#$ -o /tokp/scratch/mkraus/viVlasov1D/landau_linear_256x512_nu2E-5.out
#$ -e /tokp/scratch/mkraus/viVlasov1D/landau_linear_256x512_nu2E-5.err
#
#$ -m e
...
RUNID=landau_linear_256x512_nu2E-5_db
