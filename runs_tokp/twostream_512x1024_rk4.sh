...
#$ -pe impi_hydra 16
#
#$ -o /tokp/scratch/mkraus/petscVlasovPoisson1D/twostream_512x1024_rk4.$JOB_ID.out
#$ -e /tokp/scratch/mkraus/petscVlasovPoisson1D/twostream_512x1024_rk4.$JOB_ID.err
#
#$ -m e
...
mpiexec -perhost 16 -l -n 16 python3.3 run_nonlinear_matrixfree_split_rk4.py -c runs_tokp/$RUNID.cfg -i $JOB_ID
