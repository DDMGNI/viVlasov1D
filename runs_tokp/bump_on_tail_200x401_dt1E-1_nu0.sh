...
#$ -pe impi_hydra 16
#
#$ -o /tokp/scratch/mkraus/petscVlasovPoisson1D/bump_on_tail_200x401_dt1E-1_nu0.$JOB_ID.out
#$ -e /tokp/scratch/mkraus/petscVlasovPoisson1D/bump_on_tail_200x401_dt1E-1_nu0.$JOB_ID.err
#
#$ -m e
...
RUNID=bump_on_tail_200x401_dt1E-1_nu0
