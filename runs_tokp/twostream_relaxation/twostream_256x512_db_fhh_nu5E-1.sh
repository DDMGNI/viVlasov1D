...
#$ -pe impi_hydra 16
#
#$ -o /tokp/scratch/mkraus/viVlasov1D/twostream_256x512_db_fhh_nu5E-1.$JOB_ID.out
#$ -e /tokp/scratch/mkraus/viVlasov1D/twostream_256x512_db_fhh_nu5E-1.$JOB_ID.err
#
#$ -m e
...
RUNID=twostream_256x512_db_fhh_nu5E-1
