...
#$ -pe impi_hydra 16
#
#$ -o /tokp/scratch/mkraus/petscVlasovPoisson1D/twostream_256x512_dt1E-1_nu0_long.$JOB_ID.out
#$ -e /tokp/scratch/mkraus/petscVlasovPoisson1D/twostream_256x512_dt1E-1_nu0_long.$JOB_ID.err
#
#$ -m e
...
RUNID=twostream_256x512_dt1E-1_nu0_long
