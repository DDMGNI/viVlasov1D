...
#$ -pe impi_hydra 16
#
#$ -o /tokp/scratch/mkraus/petscVlasovPoisson1D/jeans_strong_512x1024_dt1E-1_nu0.out
#$ -e /tokp/scratch/mkraus/petscVlasovPoisson1D/jeans_strong_512x1024_dt1E-1_nu0.err
#
#$ -m e
