...
#$ -pe impi_hydra 16
#
#$ -o /tokp/scratch/mkraus/petscVlasovPoisson1D/twostream_200x401_dt1E-1_nu0_simpson.$JOB_ID.out
#$ -e /tokp/scratch/mkraus/petscVlasovPoisson1D/twostream_200x401_dt1E-1_nu0_simpson.$JOB_ID.err
#
#$ -m e
...
RUNID=twostream_200x401_dt1E-1_nu0_simpson
...
mpiexec -perhost 16 -l -n 16 python3.3 run_nonlinear_matrixfree_split_simpson.py -c runs_tokp/$RUNID.cfg -i $JOB_ID
