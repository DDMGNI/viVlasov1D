...
#$ -pe impi_hydra 16
#
#$ -o /tokp/scratch/mkraus/viVlasov1D/twostream_Arakawa4_Poisson4_128x256.$JOB_ID.out
#$ -e /tokp/scratch/mkraus/viVlasov1D/twostream_Arakawa4_Poisson4_128x256.$JOB_ID.err
#
#$ -m e
