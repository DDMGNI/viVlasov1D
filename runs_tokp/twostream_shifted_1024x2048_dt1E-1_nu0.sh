...
#$ -pe impi_hydra 16
#
#$ -o /tokp/scratch/mkraus/petscVlasovPoisson1D/twostream_shifted_1024x2048_dt1E-1_nu0.$JOB_ID.out
#$ -e /tokp/scratch/mkraus/petscVlasovPoisson1D/twostream_shifted_1024x2048_dt1E-1_nu0.$JOB_ID.err
#
#$ -m e
...
RUNID=twostream_shifted_1024x2048_dt1E-1_nu0
