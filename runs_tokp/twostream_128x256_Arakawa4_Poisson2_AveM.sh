...
#$ -pe impi_hydra 16
#
#$ -o /tokp/scratch/mkraus/petscVlasovPoisson1D/twostream_Arakawa4_Poisson2_AveM_128x256.$JOB_ID.out
#$ -e /tokp/scratch/mkraus/petscVlasovPoisson1D/twostream_Arakawa4_Poisson2_AveM_128x256.$JOB_ID.err
#
#$ -m e
