...
#$ -pe impi_hydra 16
#
#$ -o /tokp/scratch/mkraus/petscVlasovPoisson1D/twostream_shifted_256x512_dt1E-1_nu0.out
#$ -e /tokp/scratch/mkraus/petscVlasovPoisson1D/twostream_shifted_256x512_dt1E-1_nu0.err
#
#$ -m e
