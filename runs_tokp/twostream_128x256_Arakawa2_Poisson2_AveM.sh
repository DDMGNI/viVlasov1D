...
#$ -pe impi_hydra 16
#
#$ -o /tokp/scratch/mkraus/petscVlasovPoisson1D/twostream_127x256_Arakawa2_Poisson2_AveM.$JOB_ID.out
#$ -e /tokp/scratch/mkraus/petscVlasovPoisson1D/twostream_127x256_Arakawa2_Poisson2_AveM.$JOB_ID.err
#
#$ -m e
...
RUNID=twostream_127x256_Arakawa2_Poisson2_AveM
