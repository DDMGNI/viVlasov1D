...
#$ -pe impi_hydra 16
#
#$ -o /tokp/scratch/mkraus/petscVlasovPoisson1D/jeans_strong_1024x4096_dt1E-1_nu0.$JOB_ID.out
#$ -e /tokp/scratch/mkraus/petscVlasovPoisson1D/jeans_strong_1024x4096_dt1E-1_nu0.$JOB_ID.err
#
#$ -m e
...
RUNID=jeans_strong_1024x4096_dt1E-1_nu0
