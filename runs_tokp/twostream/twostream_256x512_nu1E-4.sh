...
#$ -pe impi_hydra 16
#
#$ -o /tokp/scratch/mkraus/viVlasov1D/twostream_256x512_nu1E-4.$JOB_ID.out
#$ -e /tokp/scratch/mkraus/viVlasov1D/twostream_256x512_nu1E-4.$JOB_ID.err
#
#$ -m e
...
RUNID=twostream_256x512_nu1E-4
