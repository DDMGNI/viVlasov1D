...
#$ -pe impi_hydra 16
#
#$ -o /tokp/scratch/mkraus/petscVlasovPoisson1D/twostream_100x201_dt1E-1_nu0_simpson.$JOB_ID.out
#$ -e /tokp/scratch/mkraus/petscVlasovPoisson1D/twostream_100x201_dt1E-1_nu0_simpson.$JOB_ID.err
#
#$ -m e
