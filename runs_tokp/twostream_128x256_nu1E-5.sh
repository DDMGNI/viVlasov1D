...
#$ -pe impi_hydra 16
#
#$ -o /tokp/scratch/mkraus/petscVlasovPoisson1D/twostream_128x256_nu1E-5.$JOB_ID.out
#$ -e /tokp/scratch/mkraus/petscVlasovPoisson1D/twostream_128x256_nu1E-5.$JOB_ID.err
#
#$ -m e
...
RUNID=twostream_128x256_nu1E-5
