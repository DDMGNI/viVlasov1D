...
#        OptDB.setValue('ksp_max_it', 500)
#        OptDB.setValue('ksp_max_it', 1000)

#        OptDB.setValue('snes_ls_maxstep', 100)
#        OptDB.setValue('snes_ls_steptol', 1E-10)
#
#        OptDB.setValue('snes_rtol', cfg['solver']['petsc_residual'])
#        OptDB.setValue('snes_mf_err', cfg['solver']['petsc_residual'])
        
        OptDB.setValue('snes_max_it', 100)
#        OptDB.setValue('snes_max_it', 200)
#        OptDB.setValue('snes_max_it', 500)
#        OptDB.setValue('snes_max_it', 1000)
...
#        OptDB.setValue('ksp_gmres_restart', 3)
        ...
        self.petsc_matrix  = PETScSolver(self.da1, self.da2, self.dax, self.day,
        ...
        self.A.setPythonContext(self.petsc_matrix)
        self.A.setUp()
...
#        self.snes.setJacobian(self.updateJacobian, self.A)
...
#        self.snes.setUseMF()
        ...
        self.poisson_ksp.setTolerances(rtol=1E-7)
...
#        x_arr[xs:xe, :, 1] = 0.0
        ...
        if PETSc.COMM_WORLD.getRank() == 0:
            print("   Poisson Pred:   %5i iterations,   residual = %24.16E " % (self.poisson_ksp.getIterationNumber(), self.poisson_ksp.getResidualNorm()) )
...
#        
#        if PETSc.COMM_WORLD.getRank() == 0:
#            print("   Vlasov  Pred:   %5i iterations,   residual = %24.16E " % (self.vlasov_ksp.getIterationNumber(), self.vlasov_ksp.getResidualNorm()) )
#            
#
